...
from faster_rcnn.faster_rcnn_target_driven_archA2 import FasterRCNN, RPN
...
output_dir = ('/playpen/ammirato/Data/Detections/' + 
             '/saved_models/')
save_name_base = 'FRA_TD_1-28_archA2_1'
save_freq = 3 

trained_model_path = ('/playpen/ammirato/Data/Detections/' +
                     '/saved_models/')
trained_model_name = 'FRA_TD_1-28_archA2_0_20.h5'
...
for epoch in range(num_epochs):
    ...
    for step,batch in enumerate(trainloader):
        ...
        loss *= class_weights[target_ind] * 50
    ...
    if epoch == 1:
        ...
        prev2_eal = prev_eal
        prev_eal = cur_eal
    cur_eal = epoch_loss/(step+1)

    ldiff = 2*cur_eal - prev_eal - prev2_eal
