...
def im_detect(net, target_data, target_data2, im_data, im_info):
    ...
    cls_prob, bbox_pred, rois = net(target_data, target_data2, im_data, im_info)
...
def test_net(name, net, dataloader, name_to_id, target_images, max_per_image=300, thresh=0.05, vis=False,
             output_dir=None, images_to_run=None):
...
#        #target_images[name[:-7]] = target_data
    ...
    for model_name in trained_model_names:
        ...
        # evaluation
        test_net(model_name, net, dataloader, name_to_id, target_images, max_per_image=max_per_image, thresh=thresh, vis=vis,
