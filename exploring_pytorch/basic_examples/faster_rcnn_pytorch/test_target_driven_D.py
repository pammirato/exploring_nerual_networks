...
from faster_rcnn.faster_rcnn_target_driven_archD import FasterRCNN, RPN
...
trained_model_names=[#'faster_rcnn_avd_split2_target_driven_fc7+_concat_vgg_feat_concat_train7_19',
                    ...
                    #'FRA_TD_1-5_archD_0_0',
                    #'FRA_TD_1-5_archD_0_2',
                    #'FRA_TD_1-5_archD_0_4',
                    #'FRA_TD_1-5_archD_0_6',
                    #'FRA_TD_1-5_archD_0_8',
                    #'FRA_TD_1-5_archD_0_10',
                    #'FRA_TD_1-5_archD_0_12',
                    'FRA_TD_1-5_archD_0_14',
                    #'FRA_TD_1-5_archD_0_16',
                    #'FRA_TD_1-5_archD_0_18',
                    #'FRA_TD_1-5_archD_0_20',
...
#    imdb.competition_mode(on=True)
    ...
    dataset = GetDataSet.get_fasterRCNN_AVD(data_path,
                                            scene_list,
                                            preload=False,
                                            chosen_ids=range(7),#[1,2,3,4,5,6], 
                                            by_box=False,
