...
class Part_Classifier(nn.Module):
    ...
    @property
    def loss(self):
        return self.triplet_loss*10

    def forward(self, im_data, anchor_data=None, target_box=None, other_boxes=None):
        ...
        if self.training:
            ...
            self.build_loss(img_features,anchor_features,target_box, other_boxes)
    ...
    def reshape_layer(x, d):
        ...
        try:
            ...
            print 'feat error 0'
    def build_loss(self,img_features,anchor_features, target_box, other_boxes):


        #convert target box to feature map coords
        target_id = target_box[4]
