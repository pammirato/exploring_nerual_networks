...
class PreDefinedSquareImageNet(torch.nn.Module):
    ...
    def __init__(self, image_size, num_classes):
        ...
        #conv1, with max pool
        layers.append(torch.nn.Conv2d(3,32,5))
        ...
        #conv2, with max pool
        layers.append(torch.nn.Conv2d(32,32,5))
        image_size = image_size - (5-1)
        layers.append(torch.nn.ReLU())
        image_size = image_size
        layers.append(torch.nn.MaxPool2d((2,2)))
        ...
        layers.append(Flatten(image_size*image_size*32))
        #layers.append(Flatten(image_size*image_size*3))
        layers.append(torch.nn.Linear(image_size*image_size*32, 256))
        layers.append(torch.nn.ReLU())
